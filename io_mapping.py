...
class MappingProvider:
    ...
    def generate_pi_sv(self, inputs, max_width=None, module_info=None):
        return cpp_helpers.generate_pi_sv(inputs, max_width=max_width, module_info=module_info)

    def generate_po_sv(self, output_signals, max_width=None, module_info=None):
        return cpp_helpers.generate_po_sv(output_signals, max_width=max_width, module_info=module_info)
